...
(module array racket/base
	...
	(require srfi/25
		 (only-in racket/base [for for-racket]) ;; backup original Racket 'for'
		 Scheme+/for_next_step) ;; with some scheme (guile) must be before use in array (see guile code for explaination)
