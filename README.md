...
Fixes a bug in string slicing affecting only one of the multiple  use with negative
indexes , was a bad copy/paste from vector code used for string code:
replaced now vector-ref by the good string-ref.
